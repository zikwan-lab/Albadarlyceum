...
-- RLS Policies for profiles (Fixed with proper type casting)
...
-- RLS Policies for students (Fixed with proper type casting)
...
-- RLS Policies for teachers (Fixed with proper type casting)
...
-- RLS Policies for attendance (Fixed with proper type casting)
...
-- RLS Policies for student_classes (Fixed with proper type casting)
...
-- RLS Policies for teacher_subjects (Fixed with proper type casting)
